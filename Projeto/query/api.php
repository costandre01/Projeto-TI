<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST") {
        if(isset($_POST['valor']) && isset($_POST['hora']) && isset($_POST['nome'])) {
          ...
          file_put_contents($basePath . $_POST['nome'] ."/valor.txt", $_POST['valor']);
          file_put_contents($basePath . $_POST['nome'] ."/hora.txt", $_POST['hora']);
          file_put_contents($basePath . $_POST['nome'] ."/log.txt", $_POST['hora'] .";". $_POST['valor'] . PHP_EOL, FILE_APPEND);
        } else {
